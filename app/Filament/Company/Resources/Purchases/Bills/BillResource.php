...
namespace App\Filament\Company\Resources\Purchases\Bills;
...
use App\Filament\Company\Resources\Purchases\Bills\Pages\CreateBill;
use App\Filament\Company\Resources\Purchases\Bills\Pages\EditBill;
use App\Filament\Company\Resources\Purchases\Bills\Pages\ListBills;
use App\Filament\Company\Resources\Purchases\Bills\Pages\PayBills;
use App\Filament\Company\Resources\Purchases\Bills\Pages\ViewBill;
use App\Filament\Company\Resources\Purchases\Bills\Widgets\BillOverview;
use App\Filament\Company\Resources\Purchases\Vendors\RelationManagers\BillsRelationManager;
                    ...
                    ->schema([
                        ...
                        Repeater::make('lineItems')
                            ...
                            ->table(function (Get $get) use ($settings) {
                                ...
                                if ($hasDiscounts) {
                                    $headers[] = TableColumn::make('Adjustments')->width('30%');
                                } else {
                                    $headers[] = TableColumn::make('Taxes')->width('30%');
                                }
